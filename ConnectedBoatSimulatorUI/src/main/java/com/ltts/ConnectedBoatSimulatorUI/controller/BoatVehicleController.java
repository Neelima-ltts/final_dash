...
public class BoatVehicleController {
	...
	@GetMapping("/boatvehicle")
	public Boatvehicle getVehicleDetail( ) {
		...
		vehicle.setHullid(event.getHullid());
		...
		vehicle.setIdle(event.getIdle());
		vehicle.setSpeed(event.getSpeed());
		vehicle.setTimestamp(event.getTimestamp());
